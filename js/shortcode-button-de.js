            ...
            editor.windowManager.open( {
                ...
                body: [			
                    {//add shortcode input
                        ...
                        tooltip: 'Bitte geben Sie den Kurzlink des Fragebogens an. Diesen finden Sie in Ihrem Feedbackstr - Account im Bereich Teilen'
                    },
                    {//add height input
                        type: 'textbox',
                        name: 'height',
                        label: 'iFrame Höhe:',
                        value: '640',
                        tooltip: 'Bitte geben Sie die Höhe Ihres iFrames in PX an.'
                    },
                    {//add type input
                        type: 'textbox',
                        name: 'width',
                        label: 'iFrame Breite:',
                        value: '580',
                        tooltip: 'Bitte geben Sie die Breite Ihres iFrames in PX an.'
                    },
